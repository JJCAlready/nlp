...
lines, conversations = fn.open_ds('movie_lines.txt', 'movie_conversations.txt')

# Creating a dictionary that maps each line and its id
id2line = {}
id2line = fn.dict_line_id(lines, id2line)

# Creating a list of all of the conversations
conversations_ids = []
conversations_ids = fn.list_conversations(conversations,conversations_ids)

# Getting separately the questions and the answers
questions = []
answers = []
questions, answers = fn.div_quest_ans(conversations_ids, questions, answers, id2line)


# Cleaning the questions
clean_questions = []
for question in questions:
    clean_questions.append(fn.clean_text(question))

# Cleaning the answers
clean_answers = []
for answer in answers:
    clean_answers.append(fn.clean_text(answer))

# Creating a dictionary that maps each word to its number of occurrences
word2count = {}
word2count = fn.dict_number_occur(clean_questions, word2count)
word2count = fn.dict_number_occur(clean_answers, word2count)
...
questionswords2int = {}
answerswords2int = {}
questionswords2int = fn.create_dict(word2count, questionswords2int, threshold)
answerswords2int = fn.create_dict(word2count, answerswords2int, threshold)
...
questions_into_int = []
answers_into_int = []
questions_into_int = fn.qa2int(clean_questions, questionswords2int, questions_into_int)
answers_into_int = fn.qa2int(clean_answers, answerswords2int, answers_into_int)
...
checkpoint = "./weights/checkpoint.ckpt"  # For Windows users, replace this line of code by: checkpoint = "./chatbot_weights.ckpt"
...
checkpoint = "./weights/checkpoint.ckpt"
...
def convert_string2int(question, word2int):
    question = fn.clean_text(question)
